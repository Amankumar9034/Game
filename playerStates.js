import { Dust ,Fire,Splash} from "./particls.js";
...
export class Sitting extends State{
    ...
    handleInput(input){
        ...
        else if(input.includes(' ') || input.includes('touch hold')){
...
export class Rolling extends State{
    ...
    handleInput(input){
        ...
        if((!input.includes(' ') || input.includes('touch hold'))&& this.game.player.onGround()){
            this.game.player.setState(states.RUNNING,1);
        }
        else if((!input.includes(' ')|| input.includes('touch hold')) && !this.game.player.onGround()){
            this.game.player.setState(states.FALLING,1);
        }
        else if((input.includes(' ') || input.includes('touch hold')) && (input.includes('ArrowUp')|| input.includes('swipe up')) && this.game.player.onGround()){
